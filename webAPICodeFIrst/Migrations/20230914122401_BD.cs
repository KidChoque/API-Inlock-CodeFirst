        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTipoUsuario = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdTipoUsuario0 = table.Column<Guid>(name: "{IdTipoUsuario}", type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usuario", x => x.IdUsuario);
                    table.ForeignKey(
                        name: "FK_Usuario_TipoUsuario_{IdTipoUsuario}",
                        column: x => x.IdTipoUsuario0,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuario_{IdTipoUsuario}",
                table: "Usuario",
